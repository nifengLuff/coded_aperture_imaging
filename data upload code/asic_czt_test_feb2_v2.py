...
threshold_cfg_file=r'G:\jcf_asic\threshold_cfg\20231114\threshold_cfg_feb'+str(feb_num)+'_dpm2_3.75fC_re.dat'
threshold_cfg_list=[]
...
basic_folder = r'G:\jcf_asic\data\feb2\coded_aperture_20240314'+str(feb_num)+''+'\\'
