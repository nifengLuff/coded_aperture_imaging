...
try:
    ...
    existed_file = []
    # 创建线程对象
    thread1 = threading.Thread(target = append_file, args = (existed_file_name, existed_file, local_folder, ))
    thread2 = threading.Thread(target = upload_file, args = (existed_file_name, existed_file, local_folder, remote_path, ))
